...
#        pragma GCC diagnostic ignored                                         \
            "-Wconversion" // warning: conversion to 'xxxx' from 'xxxx' may
                           // alter its value
#        pragma GCC diagnostic ignored "-Wmisleading-indentation" // [__GNUC__
                                                                  // >= 6]
                                                                  // warning:
                                                                  // this 'if'
                                                                  // clause does
...
void ImGui::ShowDemoWindow(bool *p_open)
{
    ...
    // the label.
    const float label_width_base = ImGui::GetFontSize()
...
namespace
{
    ...
    struct MyItem
    {
                                                    ...
                                                    const void *rhs)
        {
            ...
            // qsort() is instable so always return a way to differentiate
...
static void DemoWindowTables()
{
    ...
    if (ImGui::TreeNode("Advanced"))
    {
                              ...
                              inner_width_to_use))
        {
            ...
            // Show headers
            if (show_headers
                && (columns_base_flags & ImGuiTableColumnFlags_AngledHeader)
                    != 0)
                ImGui::TableAngledHeadersRow();
            if (show_headers)
                ImGui::TableHeadersRow();
